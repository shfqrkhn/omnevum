...
export type TriageDisposition = "REFERENCE" | "LINKED" | "ROUTED";
...
export function recordTriageDisposition(record: CanonicalRecord): TriageDisposition | undefined {
  return record.data.triageDisposition === "REFERENCE" || record.data.triageDisposition === "LINKED" || record.data.triageDisposition === "ROUTED" ? record.data.triageDisposition : undefined;
}
