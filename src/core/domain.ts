...
export type TriageDisposition = "REFERENCE" | "LINKED";
...
export function recordTriageDisposition(record: CanonicalRecord): TriageDisposition | undefined {
  return record.data.triageDisposition === "REFERENCE" || record.data.triageDisposition === "LINKED" ? record.data.triageDisposition : undefined;
}
