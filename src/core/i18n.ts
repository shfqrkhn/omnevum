...
export interface UiCopy {
  ...
  canonicalRecords: string; recentCaptures: string; recordCount: string; nothingCaptured: string; noMatching: string;
...
const english: UiCopy = {
  scopeWithoutCopying: "Bound records to a Space", assignToSpace: "Record", filterSpace: "View Space", allSpaces: "All Spaces", addMembership: "Add to Space", membershipCreated: (space) => `Record added to ${space}; the canonical record was not copied.`,
...
const french: UiCopy = {
  ...english,
  scopeWithoutCopying: "Associer des dossiers a un espace", assignToSpace: "Dossier", filterSpace: "Voir l'espace", allSpaces: "Tous les espaces", addMembership: "Ajouter a l'espace", membershipCreated: (space) => `Dossier ajoute a ${space}; le dossier canonique n'a pas ete copie.`,
