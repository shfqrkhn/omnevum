...
const typedRelationshipEnglish: Pick<UiCopy, "typedRelationshipKind" | "typedReference" | "dependency" | "allocation" | "synergy" | "conflict" | "feedback" | "relationshipScenario" | "allocationMode" | "exclusive" | "enabling" | "typedRelationshipHint" | "typedLinkCreated" | "scenarioRequired"> = {
...
const typedRelationshipFrench: Pick<UiCopy, "typedRelationshipKind" | "typedReference" | "dependency" | "allocation" | "synergy" | "conflict" | "feedback" | "relationshipScenario" | "allocationMode" | "exclusive" | "enabling" | "typedRelationshipHint" | "typedLinkCreated" | "scenarioRequired"> = {
  typedRelationshipKind: "Type de relation", typedReference: "Reference (existante)", dependency: "Dependance", allocation: "Allocation", synergy: "Synergie", conflict: "Conflit", feedback: "Boucle de retroaction", relationshipScenario: "ID de scenario (facultatif)", allocationMode: "Mode d'allocation", exclusive: "Exclusive", enabling: "Activante", typedRelationshipHint: "Les aretes typees sont des relations canoniques. Seules Dependance et Allocation se propagent; Synergie et Conflit sont explicatives; Retroaction exige un ID de scenario explicite.", typedLinkCreated: "Relation typee creee sans copier les dossiers.", scenarioRequired: "Les boucles de retroaction exigent un ID de scenario explicite."
};
